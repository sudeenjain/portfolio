...
function initGeneralScripts(data) {
    ...
    // --- DOCUMENTS REAL-TIME SEARCH ---
    setupPublicDocSearch();
}

/**
 * Real-time filter and search for the public Documents section
 */
function setupPublicDocSearch() {
    const input = document.getElementById('public-doc-search');
    const clearBtn = document.getElementById('public-doc-search-clear');
    const countEl = document.getElementById('public-doc-count');
